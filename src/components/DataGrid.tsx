...
export function DataGrid({
  ...
  return (
    ...
    >
      ...
      <a
        href={`#${gridTableId}`}
        className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:bg-card focus:px-4 focus:py-2 focus:text-primary-700 dark:focus:text-primary-400 focus:shadow-lg focus:rounded"
      >
