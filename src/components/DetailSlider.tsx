  ...
  return (
    <div
      ...
      className={`
        ...
        bg-card shadow-lg border-l border-border
    ...
    >
      {/* Header */}
      <div className="wcdv-slider-header flex items-center justify-between px-4 py-3 border-b border-border bg-muted">
        <h2 className="text-sm font-semibold truncate">{header}</h2>
        <IconButton
          className="wcdv-slider-close text-muted-foreground hover:text-foreground"
          onClick={onClose}
